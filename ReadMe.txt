...
- In MATLAB, right-click and Add to Path (or go to File\Set Path...\Add Folder... and add) this folder as well as linux_x64 folder.
...
- In MATLAB, right-click and Add to Path (or go to File\Set Path...\Add Folder... and add) this folder as well as mac folder.
