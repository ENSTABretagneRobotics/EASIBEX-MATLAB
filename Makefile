# You will need to build IBEX (see ReadMe.txt for the tested versions) as a shared library (see IBEX documentation) and 
# download EASIBEX-CPP (rename the folder as interval_adapt) and matrix_lib to be able to build this library (check and 
# modify the content of this Makefile to match your configuration if needed).
#
