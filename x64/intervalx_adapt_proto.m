...
%This function was generated by loadlibrary.m parser version 1.1.6.32 on Sun Dec 14 16:22:50 2014
...
%  void Cpowx ( double * pY , double * pX , unsigned int n_exp , unsigned int nb , unsigned int n , unsigned int m ); 
fcns.thunkname{fcnNum}='voidvoidPtrvoidPtruint32uint32uint32uint32Thunk';fcns.name{fcnNum}='Cpowx'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}=[]; fcns.RHS{fcnNum}={'doublePtr', 'doublePtr', 'uint32', 'uint32', 'uint32', 'uint32'};fcnNum=fcnNum+1;
